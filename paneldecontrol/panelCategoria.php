...
if(isDataAvailable($_SESSION)) {
    if(isDataAvailable($_SESSION['userId'])) {
        ...
        include_once "../Classes/Categoria.php.php";
        ...
        if (isset($_POST)&& !empty($_POST)){
            if ($_POST['nom_cat']!="" && is_numeric($_POST['pre_pro']) && is_numeric($_POST['stock_pro']) && $_POST['descr_pro']!="" && $_POST['id_empr']!=0){
...
<section class="mainContainer">
    <form  enctype="multipart/form-data" name="modificar" action="<?php echo $_SERVER['PHP_SELF']."?id=".$id ?>" method="post">
        <ul><div class="dataContainer">
                <input type="hidden" name="id_cat" value="<?php echo $producto->getIdPro() ?>">
                <li><label>Nombre</label></li><li><input value="<?php echo $producto->getNomPro()?>" type="text" id="nombre" class="inputForm inputSingleLined" placeholder="Nombre del producto" name="nom_cat"></li>
